...
초보자의 눈으로 봐도 이해가 가기 쉽게, 간결히 작성하였습니다. 덕분에 쉽게 읽혀서 좋은 코드라고 판단 하였습니다.
def is_palindrome(text) 함수를 쓰고자 노력했습니다. 회문코드라고 검색한 코드입니다.
r=n[::-1] 코드에 대해 알 수 있었습니다. 위에 검색한 코드외에 다른 회문 코드를 알 수 있었습니다.
